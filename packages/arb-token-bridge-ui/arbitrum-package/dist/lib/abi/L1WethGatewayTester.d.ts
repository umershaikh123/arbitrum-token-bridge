...
export interface L1WethGatewayTesterInterface extends utils.Interface {
    contractName: "L1WethGatewayTester";
    functions: {
...
export interface L1WethGatewayTester extends BaseContract {
    contractName: "L1WethGatewayTester";
    ...
    functions: {
        ...
        initialize(_l1Counterpart: string, _l1Router: string, _inbox: string, _l1Weth: string, _l2Weth: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getOutboundCalldata(_l1Token: string, _from: string, _to: string, _amount: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<string>;
        inbox(overrides?: CallOverrides): Promise<string>;
        initialize(_l1Counterpart: string, _l1Router: string, _inbox: string, _l1Weth: string, _l2Weth: string, overrides?: CallOverrides): Promise<void>;
        l1Weth(overrides?: CallOverrides): Promise<string>;
        l2Weth(overrides?: CallOverrides): Promise<string>;

...
export interface L1GatewayRouterTesterInterface extends utils.Interface {
    contractName: "L1GatewayRouterTester";
    functions: {
...
export interface L1GatewayRouterTester extends BaseContract {
    contractName: "L1GatewayRouterTester";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: L1GatewayRouterTesterInterface;
    ...
    functions: {
        ...
        initialize(_owner: string, _defaultGateway: string, _whitelist: string, _counterpartGateway: string, _inbox: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getOutboundCalldata(_token: string, _from: string, _to: string, _amount: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<string>;
        inbox(overrides?: CallOverrides): Promise<string>;
        initialize(_owner: string, _defaultGateway: string, _whitelist: string, _counterpartGateway: string, _inbox: string, overrides?: CallOverrides): Promise<void>;
        l1TokenToGateway(arg0: string, overrides?: CallOverrides): Promise<string>;

...
export interface L2CustomGatewayTesterInterface extends utils.Interface {
    contractName: "L2CustomGatewayTester";
    functions: {
    ...
    encodeFunctionData(functionFragment: "registerTokenFromL1", values: [string[], string[]]): string;
    ...
    decodeFunctionResult(functionFragment: "registerTokenFromL1", data: BytesLike): Result;
...
export interface L2CustomGatewayTester extends BaseContract {
    contractName: "L2CustomGatewayTester";
    ...
    functions: {
        ...
        initialize(_l1Counterpart: string, _router: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        registerTokenFromL1(l1Address: string[], l2Address: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getOutboundCalldata(_token: string, _from: string, _to: string, _amount: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<string>;
        initialize(_l1Counterpart: string, _router: string, overrides?: CallOverrides): Promise<void>;
        l1ToL2Token(arg0: string, overrides?: CallOverrides): Promise<string>;
        ...
        registerTokenFromL1(l1Address: string[], l2Address: string[], overrides?: CallOverrides): Promise<void>;
        router(overrides?: CallOverrides): Promise<string>;

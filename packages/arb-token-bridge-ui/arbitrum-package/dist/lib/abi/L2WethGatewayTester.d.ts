...
export interface L2WethGatewayTesterInterface extends utils.Interface {
    contractName: "L2WethGatewayTester";
    functions: {
    ...
    encodeFunctionData(functionFragment: "setL2WethAddress", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "setL2WethAddress", data: BytesLike): Result;
...
export interface L2WethGatewayTester extends BaseContract {
    contractName: "L2WethGatewayTester";
    ...
    functions: {
        ...
        initialize(_l1Counterpart: string, _router: string, _l1Weth: string, _l2Weth: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setL2WethAddress(_l2Weth: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getOutboundCalldata(_token: string, _from: string, _to: string, _amount: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<string>;
        initialize(_l1Counterpart: string, _router: string, _l1Weth: string, _l2Weth: string, overrides?: CallOverrides): Promise<void>;
        l1Weth(overrides?: CallOverrides): Promise<string>;
        l2Weth(overrides?: CallOverrides): Promise<string>;

...
export interface L2GatewayRouterTesterInterface extends utils.Interface {
    contractName: "L2GatewayRouterTester";
    functions: {
    ...
    encodeFunctionData(functionFragment: "setDefaultGateway", values: [string]): string;
    encodeFunctionData(functionFragment: "setGateway", values: [string[], string[]]): string;
...
export interface L2GatewayRouterTester extends BaseContract {
    contractName: "L2GatewayRouterTester";
    ...
    functions: {
        ...
        initialize(_counterpartGateway: string, _defaultGateway: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        "outboundTransfer(address,address,uint256,uint256,uint256,bytes)"(_token: string, _to: string, _amount: BigNumberish, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _data: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setDefaultGateway(newL2DefaultGateway: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setGateway(_l1Token: string[], _gateway: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getGateway(_token: string, overrides?: CallOverrides): Promise<string>;
        getOutboundCalldata(_token: string, _from: string, _to: string, _amount: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<string>;
        initialize(_counterpartGateway: string, _defaultGateway: string, overrides?: CallOverrides): Promise<void>;
        l1TokenToGateway(arg0: string, overrides?: CallOverrides): Promise<string>;
        ...
        "outboundTransfer(address,address,uint256,uint256,uint256,bytes)"(_token: string, _to: string, _amount: BigNumberish, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<string>;
        postUpgradeInit(overrides?: CallOverrides): Promise<void>;
        router(overrides?: CallOverrides): Promise<string>;
        setDefaultGateway(newL2DefaultGateway: string, overrides?: CallOverrides): Promise<void>;
        setGateway(_l1Token: string[], _gateway: string[], overrides?: CallOverrides): Promise<void>;
